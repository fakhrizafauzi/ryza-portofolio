...
export interface Project extends BaseDoc {
    ...
    testimonials?: { quote: string, author: string, role?: string, avatar?: string, url?: string }[];
    processSteps?: { title: string, description?: string, icon?: string, url?: string }[];
    techStack?: { name: string, icon?: string, level?: string, url?: string }[];
    features?: { title: string, description?: string, url?: string }[];
    userPersonas?: { name: string, role: string, bio: string, goals?: string, pains?: string, avatar?: string, url?: string }[];
    ...
    architecture?: { title: string, description: string, image?: string, url?: string }[];
